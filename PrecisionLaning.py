...
horizontal_fov = 68 * (math.pi / 180 ) ##My Webcam: 68
vertical_fov = 48.8 * (math.pi / 180)   ##My Webcam: 48.8
...
def send_local_ned_velocity(velocity_x, velocity_y, velocity_z):
	...
	vehicle.flush() # Call flush() after adding or clearing mission commands.
